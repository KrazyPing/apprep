export const PHYSICS_UNITS = [
  {
    id: 'p1',
    title: 'Unit 1: Kinematics (Calculus Integration)',
    weight: '14% of AP Exam',
    overview: '1D and 2D vector kinematics analyzed with calculus derivatives and line integrals when acceleration varies.',
    lessons: [
      {
        title: 'Kinematic Calculus Integration',
        text: 'v(t) = dx/dt, a(t) = dv/dt = d²x/dt². Position x(t) = x_0 + ∫ v(t) dt. Use a = v(dv/dx) when a is a function of position x.',
        formula: 'a(x) = v · (dv ÷ dx)   |   x(t) = x_0 + ∫ v(t) dt',
        apTip: 'Constant acceleration equations fail when a is variable; calculus derivatives/integrals are required.'
      }
    ],
  ...
  {
    id: 'p2',
    title: 'Unit 2: Newton's Laws of Motion & Drag Forces',
    ...
    lessons: [
      {
        title: 'Resistive Drag Forces & Terminal Velocity',
  ...
  },
  {
    ...
    lessons: [
      {
        title: 'Center of Mass & Impulse Integrals',
  ...
  },
  {
    ...
    lessons: [
      {
        title: 'Gravitational Calculus & Orbital Energy',
